...
namespace SiameseCatAzukiSan.Dusts
{
	...
	internal class AdvancedDust : ModDust
	{
		/*
			...
			This dust is not used in SiameseCatAzukiSan yet, so you'll have to add some code somewhere. Try ExamplePlayer.DrawEffects.
