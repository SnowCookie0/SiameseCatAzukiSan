using SiameseCatAzukiSan.Buffs;
...
namespace SiameseCatAzukiSan.Mounts
{
	public class Ebi : ModMountData
	{
		...
		public override void UpdateEffects(Player player) {
			...
			var balloons = (EbiSpecificData)player.mount._mountSpecificData;
		...
		internal class EbiSpecificData
		{
		...
		public override void SetMount(Player player, ref bool skipDust) {
			// When this mount is mounted, we initialize _mountSpecificData with a new EbiSpecificData object which will track some extra visuals for the mount.
			player.mount._mountSpecificData = new EbiSpecificData();
